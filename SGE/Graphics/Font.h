...
public:
	...
	// Function to set/cache the text that is rendered.
	...
	// Function to draw text (will replace the cached text string).
	void PrintText(const char* pText, int iPosX = 0, int iPosY = 0);

	// Function to render the cached text string.
	void Render(int iPosX = 0, int iPosY = 0);
...
private:
	...
	char		mCachedString[kMaxStringSize];
};
